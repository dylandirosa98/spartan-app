...
export default function SettingsPage() {
  ...
  const webhookUrl = typeof window !== 'undefined'
    ? `${window.location.origin}/api/webhooks/twenty/${companyId}`
    : '';
        ...
        <Tabs defaultValue="api" className="space-y-4">
          ...
          <TabsContent value="api" className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Webhook className="h-5 w-5 text-[#C41E3A]" />
                  Webhook Configuration
                </CardTitle>
                <CardDescription>
                  Configure real-time updates from Twenty CRM to your application
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <ol className="text-sm text-blue-700 space-y-1 list-decimal list-inside">
                        <li>Copy your company-specific webhook URL below</li>
                        <li>Go to Twenty CRM → Settings → Developers → Webhooks</li>
                        <li>Create a new webhook and paste the URL</li>
                        <li>Select events: <code className="bg-blue-100 px-1 rounded">lead.created</code>, <code className="bg-blue-100 px-1 rounded">lead.updated</code>, <code className="bg-blue-100 px-1 rounded">lead.deleted</code></li>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <div className="flex-1 rounded-md border bg-gray-50 px-3 py-2 font-mono text-sm text-gray-900 overflow-x-auto">
                      {webhookUrl || 'Loading...'}
                    </div>
                    <Button
                  ...
                  <p className="text-xs text-gray-500">
                    This URL is unique to your company and should be kept secure
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-1">
                      <h4 className="font-medium text-green-900">Real-time Sync Enabled</h4>
                      <p className="text-sm text-green-700">
                        Once configured, any changes to leads in Twenty CRM will automatically
                        sync to your application in real-time.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <TabsContent value="about" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Version and status information for Spartan Systems
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex items-center justify-between py-3 border-b">
                    ...
                    <span className="text-sm font-semibold text-[#C41E3A]">Spartan Systems</span>
                  </div>
                  <div className="flex items-center justify-between py-3 border-b">
            ...
            <Card>
              <CardHeader>
                <CardTitle>About Spartan Systems</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <p className="text-sm text-gray-600">
                  Spartan Systems is an enterprise-grade Progressive Web App designed for
                ...
                <div className="pt-2">
                  <p className="text-xs text-gray-500">
                    &copy; 2024 Spartan Systems. All rights reserved.
                  </p>
                </div>
              </CardContent>
            </Card>
